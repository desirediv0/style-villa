...
export const metadata = {
    title: "Return Policy | stylevilla",
                ...
                <div className="section-container max-w-4xl">
                    ...
                    <div className="prose prose-lg max-w-none">
                        ...
                        <ol className="space-y-3 mb-8 list-decimal list-inside">
                            <li><strong>Contact Support:</strong> Email us at stylevilla.ktl@gmail.com </li>
                        ...
                        <ul className="space-y-2">
                            <li>Email: <strong>stylevilla.ktl@gmail.com</strong></li>
