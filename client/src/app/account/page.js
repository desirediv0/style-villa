                ...
                <div className="container mx-auto py-10 px-4">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm mb-8">
                        <div className="p-4 lg:p-6">
                            ...
                            {message.text && <div className={`mb-4 p-3 rounded-xl ${message.type === "success" ? "bg-green-50 text-green-800 border border-green-200" : "bg-red-50 text-red-800 border border-red-200"}`}>{message.text}</div>}
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm mb-8">
                        <div className="p-4 lg:p-6">
                            <div className="flex justify-between gap-2 items-center mb-4">
                                ...
                                <Link href="/account/addresses"><Button variant="outline" size="sm" className="text-wrap py-2 rounded-xl">Manage Addresses</Button></Link>
                            </div>
                            ...
                            {addresses.length > 0 ? (
                                ...
                                <div className="text-center py-6 border border-gray-100 rounded-xl">
                                    ...
                                    <Link href="/account/addresses" className="mt-2 inline-block"><Button variant="outline" size="sm" className="mt-2 rounded-xl">Add Address</Button></Link>
                                </div>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm">
                        <div className="p-6">
                            ...
                            <Link href="/account/change-password"><Button variant="outline" className="w-full sm:w-auto rounded-xl"><DynamicIcon name="Lock" className="mr-2 h-4 w-4" />Change Password</Button></Link>
                        </div>
                    </div>
                </div>
            </ClientOnly>
