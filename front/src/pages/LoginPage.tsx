        ...
        <div className="w-full max-w-md space-y-8 relative z-10">
          ...
          <div className="space-y-3">
            <h1 className="text-4xl lg:text-5xl   text-white leading-tight    tracking-tight">
              Style Villa <span className="text-[#14A8E6]">Admin Portal</span>
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full h-12 px-4 bg-zinc-950/50 backdrop-blur-sm border rounded-lg text-white placeholder-zinc-700 
                    ...
                    ${focusedField === "email"
                      ? "border-[#A458A6] shadow-[0_0_0_3px_rgba(164,88,166,0.1)]"
            ...
            <Button
              type="submit"
              className="w-full h-12 text-sm   bg-[#A458A6] hover:bg-[#93469B] 
                border border-[#A458A6] hover:border-[#93469B] 
